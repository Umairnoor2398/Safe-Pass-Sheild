...
import 'package:safe_pass_sheild/authenticator/application_model.dart';
import 'package:safe_pass_sheild/authenticator/components/home/addappmodal.dart';
import 'package:safe_pass_sheild/authenticator/components/home/updateappmodal.dart';
import 'package:safe_pass_sheild/authenticator/storage_util.dart';
                  ...
                  children: [
                    ...
                    apps.isNotEmpty
                        ? Expanded(
                            ...
                            children: apps
                                .map((app) =>
                                    app.display(context, onEdit: _editApp))
                                .toList(),
                          ))
                        : const Padding(
